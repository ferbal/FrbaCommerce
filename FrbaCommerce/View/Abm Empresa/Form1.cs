        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // }
                ...
                if(validarDatos())
                    Controller.Empresas.ingresarNuevaEmpresa(txtRazonSocial.Text, txtCuit.Text, txtNombreContacto.Text, txtMail.Text, txtTelefono.Text, txtCalle.Text, piso, depto, txtLocalidad.Text, codigoPostal, Convert.ToDateTime(txtFechaNac.Text));
